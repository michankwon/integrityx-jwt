#!/usr/bin/env python3
"""
Test script for the simplified loan schemas validation.

This script demonstrates the Pydantic models for API request/response validation
with comprehensive field validation and data masking.
"""
...
from loan_schemas_simple import (
...
def main():
    """Run all tests."""
    print("🔍 SIMPLIFIED LOAN SCHEMAS VALIDATION TEST")
    print("=" * 50)
